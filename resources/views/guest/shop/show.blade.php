    ...
    <div class="content">
        <div class="sidebar-left">
            ...
            <div class="filter">
                        ...
                        <form action=" {{ route('shop.filter') }} " method="POST">
                            ...
                            <ul>
                                ...
                                <li> 
                                    <ul >
                                        <li>
                                            <div class="checkbox-category" data-process="{{ route("shop.show") }}">
                                                <input class="checkbox-custom-feature" type="checkbox" name="categories[]" value="{{ $cate->id }}" id="category-{{ $cate->id }}" ><label class="checkbox-important" for="category-{{ $cate->id }}">{{ $cate->name }}</label> 
                                            </div>
                                            
                                            {{-- @if( !empty(json_decode(data_tree($categories,$cate->id),true)))
                ...
                {{-- <div class="filter-color">
                    ...
                    <div class="filter-content">
                        <div class="filter-color-input-custom">
                            <ul>
                                <li><input type="checkbox" id="color-child-1"> <label  class="color-black" for="color-child-1">Black<span>(15)</span></label></li>
                                <li><input type="checkbox" id="color-child-2"> <label  class="color-red" for="color-child-2">Red<span>(15)</span></label></li>
                                <li><input type="checkbox" id="color-child-3"> <label  class="color-blue" for="color-child-3">Blue<span>(15)</span></label></li>
                                <li><input type="checkbox" id="color-child-4"> <label   class="color-yellow" for="color-child-4">Yellow<span>(15)</span></label></li>
                            </ul>
                            ...
                            <form action="{{ route("shop.filter") }}" method="POST">
                                ...
                                <ul>
                                    @foreach ($brands as $brand)
                                        <li><input type="checkbox" name="brands[]" value="{{$brand->id}}" id="brand-child-{{$brand->id}}"> <label class="checkbox-important"  for="brand-child-{{$brand->id}}">{{$brand->brand_name}}<span>({{ $brand->products->count() }})</span></label></li>
                                    @endforeach
                                </ul>
                ...
                {{-- <div class="filter-rating">
                    ...
                    <div class="filter-content">
                        <div class="filter-star">
                            <a href="#">
                            <i class="fas fa-star good-rate"></i>
                            <i class="fas fa-star good-rate"></i>
                            <i class="fas fa-star good-rate"></i>
                            <i class="fas fa-star good-rate"></i>
                            <i class="fas fa-star good-rate"></i>
        ...
        <div class="shop-detail-content">
            <div class="banner-advertising">
                <p>The Salad</p>
                <p>Fresh & Natural <br>
                    Healthy Food Special Offer</p>
                <p>Do not miss the current offers of us!</p>
            </div>
            {{-- <div class="navigation">
                <div class="show">
                    <p>Showing 1 - 18 of 40 Products</p>
                </div>
                <div class="view">
                                ...
                                <div class="product-instock-right opacity-hiden">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            // [ "slug" => $product->product_slug , "id" => $product->id ]
                                            )}}">
