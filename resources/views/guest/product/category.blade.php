                        ...
                        <div class="filter-brand-input-custom">
                            <ul>
                                @foreach ($brands as $brand)
                                    <li><input type="checkbox" id="brand-child-{{$brand->id}}"> <label class="checkbox-important"  for="brand-child-{{$brand->id}}">{{$brand->brand_name}}<span>({{ $brand->products->count() }})</span></label></li>
                                @endforeach
                            </ul>
