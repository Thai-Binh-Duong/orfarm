        ...
        <div class="card-body">
            <form action="{{route('admin.post.update',$post->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="post_description" class="form-control" id="description"  value="{{ $post->post_description }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="post_content" class="form-control textarea" id="content" cols="30" rows="5"> {{ $post->post_content }}</textarea>
                    @error('post_content')
                        <p class="alert alert-danger">{{ $message }}</p>
                    @enderror
                </div>
