    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('product.tag.update',$tag)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            @foreach ( $tags as $tag)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='{{route("product.tag.delete",$tag->id)}}' class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
